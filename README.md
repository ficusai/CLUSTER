...
**Modular design:** Each large file has been decomposed into single-responsibility modules using a mixin-composition pattern. Every public entry point (`cluster.py`, `src/root/main.py`, `src/worker/main.py`) remains as a thin shim for backward compatibility.
